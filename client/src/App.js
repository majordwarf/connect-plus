        ...
        <div className="u-margin-top-xxlarge u-margin-bottom-xxlarge">
          <div className="o-wrapper-l">
            <div className="hero flex flex-column">
              <div>
                <div className="welcomeText">Connect+</div>
                <div className="descriptionText">Video Chat & Screen Share</div>
              </div>
              ...
              <div>
                To call your partner, ask them to open Connect+ in their
                browser. <br />
                Send your ID (<span className="username">{yourID}</span>) and
                wait for their call <span style={{ fontWeight: 600 }}>OR</span>{" "}
                enter their username and hit call!
              </div>
            </div>
          </div>
        </div>
  ...
  function callPeer(id) {
    if (id !== "" && users[id] && id !== yourID) {
      navigator.mediaDevices
        ...
        .catch(() => {
          setModalMessage(
            "You cannot place/ receive a call without granting video and audio permissions! Please change your settings to use Connect+."
          );
